                    ...
                    <div class="col-sm-10 col-sm-offset-1">
                        ...
                        <div class="row header-controls">
                            <div class="col-sm-6 filterSort">
                                <span class="filter"><i class="fa fa-filter"></i> Filter By <i class="fa fa-sort-desc"></i></span><span class="horizontal">|</span><span class="sort"><i class="fa fa-exchange fa-rotate-90"></i> Sort By <i class="fa fa-sort-desc"></i></span>
                            </div>
