...
class EventfulController extends BaseController { 
	...
	public function events() {
		...
		$event = file_get_contents('http://api.eventful.com/json/events/search?location=Atlanta&date=today&sort_order=date&sort_direction=descending&app_key=pLB3SGLn9xSnfcg5');
